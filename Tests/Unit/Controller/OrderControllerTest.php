...
/**
 * Test case for class Tx_Grb_commerce_order_Controller_OrderController.
 *
 * @version $Id$
 ...
 */
class Tx_Grb_commerce_order_Controller_OrderControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
